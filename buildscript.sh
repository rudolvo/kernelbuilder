...
sudo apt install build-essential gcc-aarch64-linux-gnu gperf lib32ncurses5-dev lib32readline-dev lib32z1-dev libelf-dev liblz4-tool libncurses5 libncurses5-dev libsdl1.2-dev lzop clang schedtool ccache rsync -y
mkdir -p out
echo "Starting make..."
make clean
make mrproper
